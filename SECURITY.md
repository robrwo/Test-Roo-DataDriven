This is the Security Policy for the Perl distribution Test-Roo-DataDriven.

The latest version of this Security Policy can be found in the Git repository
[https://github.com/robrwo/Test-Roo-DataDriven](https://github.com/robrwo/Test-Roo-DataDriven).
...
Any security vulnerabilities in Test-Roo-DataDriven are covered
by this policy.
...
by this policy unless they affect Test-Roo-DataDriven, or
Test-Roo-DataDriven can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that
uses Test-Roo-DataDriven, or plugins to it that are not included
with the Test-Roo-DataDriven distribution) are not covered by
this policy.

## Which Versions of this Software are Supported?

The maintainer(s) will only commit to releasing security fixes for the
latest version of Test-Roo-DataDriven.

Note that the Test-Roo-DataDriven project only supports major
versions of Perl released in the past ten (10) years, even though
Test-Roo-DataDriven will run on older versions of Perl.  If a
